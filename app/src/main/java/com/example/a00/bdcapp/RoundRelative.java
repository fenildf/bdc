...
public class RoundRelative extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.RoundRelative);
        color = array.getColor(R.styleable.RoundRelative_background_color,0X0000000);
        alpha = array.getInteger(R.styleable.RoundRelative_background_alpha,100);
        setColors();
        array.recycle();
    }
    @Override
